...
class BackupServiceTests(unittest.TestCase):
    ...
    def test_a_vote_rounds_rotation_id_survives_backup_and_restore(self):
        ...
        # Corrupt the live file, simulating data loss /restore must undo.
        voting_path.write_text(json.dumps({"next_round_id": 1, "rounds": []}), encoding="utf-8")
        self.assertEqual(repository.load().rounds, [])
