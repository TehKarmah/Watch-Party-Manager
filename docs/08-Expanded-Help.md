...
- `/database health` -- Show a collection's eligibility and pool health (Eligible, In an Active Vote, Vote Winners, Retired, Watched, Next Vote status, Low Pool status). Never changes rotation state.
