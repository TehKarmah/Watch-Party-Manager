...
| `/database manage` | WASH Crew | Guided workflow: pick a collection, then choose what to do with it (move, edit, back up, refresh IMDb metadata, reset, or remove). |
