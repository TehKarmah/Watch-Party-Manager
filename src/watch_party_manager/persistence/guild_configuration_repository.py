    ...
    def _serialize(cls, c: GuildConfiguration) -> dict[str, Any]:
        return cls._merge(c.extra_fields, {
            ...
            "channels": cls._merge(c.channels.extra_fields, {
                ...
                "home_channel_id": c.channels.home_channel_id,
            }),
    ...
    def _deserialize(cls, entry: dict[str, Any]) -> GuildConfiguration:
        ...
        return GuildConfiguration(
            ...
            channels=GuildChannelsConfig(
                ...
                home_channel_id=channels.get("home_channel_id"),
                extra_fields=cls._split_known(
                    channels,
                    {
                        "announcements_channel_id", "log_channel_id", "admin_channel_id",
                        "watch_history_channel_id", "home_channel_id",
                    },
                ),
            ),
